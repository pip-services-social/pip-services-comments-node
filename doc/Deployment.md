# Deployment Guide <br/> Comments Microservice

Comments microservice can be used in different deployment scenarios.
...
The Comments microservice can also be used as a Seneca plugin.
...
```javascript
{
    ...
    "dependencies": {
        ....
        "pip-services-comments-node": "^1.1.*",
        ...
    }
}
```
...
var plugin = new require('pip-services-comments-node').CommentsSenecaPlugin;
...
or by using [CommentsSenecaClient](https://github.com/pip-services-content/pip-clients-comments-node/doc/NodeClientApiV1.md/#client_seneca)