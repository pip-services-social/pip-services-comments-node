...
export interface ICommentsPersistence extends IGetter<CommentV1, string>, IWriter<CommentV1, string> {
    ...
    increment(correlationId: string, id: string,
        callback?: (err: any, review: CommentV1) => void): void;

    decrement(correlationId: string, id: string,
        callback?: (err: any, review: CommentV1) => void): void;

    addMeme(correlationId: string, id: string, creator_id: string, meme_type: string,
        callback: (err: any, review: CommentV1) => void): void;

    removeMeme(correlationId: string, id: string, creator_id: string, meme_type: string,
        callback: (err: any, review: CommentV1) => void): void;
